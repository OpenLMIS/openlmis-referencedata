...
* [OLMIS-4531](https://openlmis.atlassian.net/browse/OLMIS-3494): Refactored searching for processing periods to use one query and not retrieve unnecessary data.
