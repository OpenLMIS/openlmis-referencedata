 ...
 */
@Component
public class PageableValidator implements BaseValidator {
  ...
  public void validate(Object target, Errors errors) {
    ...
    if (ctx.getPage() != null) {
      if (ctx.getSize() == null) {
        rejectValue(errors, SIZE, PageableMessageKeys.ERROR_SIZE_NULL);
      } else if (ctx.getSize()  < 1) {
        rejectValue(errors, SIZE, PageableMessageKeys.ERROR_SIZE_NOT_POSITIVE);
      }
    }
  }
}
