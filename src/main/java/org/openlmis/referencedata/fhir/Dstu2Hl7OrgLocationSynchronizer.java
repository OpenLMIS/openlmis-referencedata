...
class Dstu2Hl7OrgLocationSynchronizer extends LocationSynchronizer<Location> {
  ...
  ICriterion createIdentifierCriterion(String system, UUID value) {
    ...
    return new TokenClientParam(Location.SP_IDENTIFIER)
        .exactly()
        .systemAndValues(system, value.toString());
  }
