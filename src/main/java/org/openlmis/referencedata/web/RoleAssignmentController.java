...
public class RoleAssignmentController extends BaseController {
  ...
  /**
   * Get all role assignments of all users, each tagged with the user it belongs to.
   *
  ...
  @ResponseBody
  public Page<UserRoleAssignmentDto> getRoleAssignments(Pageable pageable) {
    Profiler profiler = new Profiler("GET_ALL_ROLE_ASSIGNMENTS");
