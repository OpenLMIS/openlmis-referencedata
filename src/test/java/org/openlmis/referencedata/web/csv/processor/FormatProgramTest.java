...
public class FormatProgramTest {
  ...
  @Test
  public void shouldFormatValidProgram() throws Exception {
    ProgramDto program = new ProgramDto();
    program.setCode("program-code");

    String result = (String) formatProgram.execute(program, csvContext);
  ...
  @Test
  public void shouldThrownExceptionWhenValueIsNotProgramDtoType() {
