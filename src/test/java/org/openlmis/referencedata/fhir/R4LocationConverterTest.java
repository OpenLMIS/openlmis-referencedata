...
public class R4LocationConverterTest {

  private static final String SERVICE_URL = "http://localhost";
  private R4LocationConverter converter = new R4LocationConverter();
  ...
  public void shouldCovertOpenLmisLocationToFhirLocation() {
    ...
    assertThat(fhirLocation.getAlias()).hasSize(olmisLocation.getAlias().size());
    olmisLocation
        .getAlias()
        .forEach(alias -> assertThat(fhirLocation.getAlias())
  ...
  public void shouldAddSystemIdentifier() {
    ...
    org.hl7.fhir.r4.model.Location resource = new org.hl7.fhir.r4.model.Location();
