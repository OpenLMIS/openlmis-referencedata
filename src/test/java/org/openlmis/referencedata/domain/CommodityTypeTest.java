...
public class CommodityTypeTest {
  ...
  static {
    ibuprofen =
        new CommodityType(null, "ibuprofen", CLASSIFICATION_SYS, CLASSIFICATION_SYS_ID, null, null);
  ...
  private CommodityType generateCommodityType(String productName) {
    CommodityType commodityType = new CommodityType(null, productName, "CS", "CID", null, null);
