...
public class FacilityTypeControllerIntegrationTest
    extends AuditLogWebIntegrationTest<FacilityType> {
  ...
  @Override
  protected FacilityType getInstance() {
    return facilityType;
  }

  @Override
  protected CrudRepository<FacilityType, UUID> getRepository() {
  ...
  protected String getErrorNotFoundMessage() {
    return FacilityTypeMessageKeys.ERROR_NOT_FOUND;
  }
}
